    ...
    def _extract_tokens(text):
        try:
            ...
            try:
                ...
                # Use extract_tags to get keywords by TF-IDF, which is better for extracting main topics like "岁宝"
                toks = jieba.analyse.extract_tags(s, topK=20)
            except ImportError:
                import re
                parts = []
            ...
            for t in toks:
                ...
                # filter out pure numbers unless they are special
